...
* `POST /nutrition/analyze`: Accepts an image file of a meal. The system uses a vision model to analyse the food and estimate total calories, generate a brief description and extract macronutrient details.
